      ...
      <div className='flex items-center flex-grow bg-amazon_blue  p-1'>
        ...
        <div className='text-white flex items-center space-x-6 mx-6 text-md whitespace-nowrap'>
          ...
          <div className='link flex items-center relative'>
            ...
            <p className='font-black md:text-sm '>
              <Link to="/cart">
                Cart
                {cart.cartItems.length > 0 && (
                  <div className='absolute bg-yellow-500 top-0 right-0 h-4 w-4 rounded-full text-center md:right-10 text-black font-bold'> {cart.cartItems.length}</div>
                )}
              </Link>
            </p>
          </div>
